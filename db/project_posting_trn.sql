...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/ysr922/F362KCEQY/project_posting_trn.sql?nojsmode=1" /></noscript>
<script>(function() {
        'use strict';
...
<script>(function() {
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U2H2MLNMC");
							sb('set', 'user_' + "batch", "signup_api");
							sb('set', 'user_' + "created", "2016-09-28");
						sb('set', 'name_tag', "ramstalk" + '/' + "takutotacos");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>project_posting_trn.sql | RAMs Slack</title>
    <meta name="author" content="Slack">
			...
			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/d0b0c/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://secure.gravatar.com/avatar/2c8159cf30fee74fc3a6a1dfc3dcf7ba.jpg?s=192&d=https%3A%2F%2Fa.slack-edge.com%2F7fa9%2Fimg%2Favatars%2Fava_0024-192.png')" data-thumb-size="48" data-member-id="U2H2MLNMC"></span>
					<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/2c8159cf30fee74fc3a6a1dfc3dcf7ba.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0024-72.png')" data-thumb-size="36" data-member-id="U2H2MLNMC"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">takutotacos</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/85086199314?crumb=s-1480368560-c2993713fb-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
					...
					<span class="block label">Help</span>
						...
						<span class="block label">Launch</span>
				                    ...
				                    <ul id="header_team_nav" data-qa="team_switcher_menu">
	                        	                            <li class="active">
	                            	<a href="https://ramstalk.slack.com/home" target="https://ramstalk.slack.com/">
	                            			                            			<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
	                            			                            			                            			<i class="team_icon small default" >R</i>
	                            			                            		<span class="switcher_label team_name">RAMs</span>
	                            	</a>
	                            </li>
...
<p class="print_only">
	<strong>Created by ysr922 on November 24, 2016 at 11:18 PM</strong><br />
	<span class="subtle_silver break_word">https://ramstalk.slack.com/files/ysr922/F362KCEQY/project_posting_trn.sql</span>
</p>
...
<div class="alert_container">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T2H2J5V98-F362KCEQY-cb0f9afc86" target="new">https://slack-files.com/T2H2J5V98-F362KCEQY-cb0f9afc86</a>
</div></div>

<div id="file_page" class="card top_padding">

	<p class="small subtle_silver no_print meta">
		2KB SQL snippet created on <span class="date">November 24th 2016</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
...
--
-- Table structure for table `posting_trn`
--

DROP TABLE IF EXISTS `posting_trn`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `posting_trn` (
...
--
-- Dumping data for table `posting_trn`
--

LOCK TABLES `posting_trn` WRITE;
/*!40000 ALTER TABLE `posting_trn` DISABLE KEYS */;
/*!40000 ALTER TABLE `posting_trn` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-11-24 23:17:52
</pre>
	...
	<div class="col span_4_of_6 no_right_padding">
		...
		<form action="https://ramstalk.slack.com/files/ysr922/F362KCEQY/project_posting_trn.sql"
		id="file_comment_form"
					class="comment_form clearfix"
				method="post">
			<a href="/team/takutotacos" class="member_preview_link" data-member-id="U2H2MLNMC" >
			<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/2c8159cf30fee74fc3a6a1dfc3dcf7ba.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0024-72.png')" data-thumb-size="36" data-member-id="U2H2MLNMC"></span>
		</a>
		<input type="hidden" name="addcomment" value="1" />
	<input type="hidden" name="crumb" value="s-1480368560-6edd38acde-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U2H2MLNMC',
		no_login: false,
		version_ts: '1480368327',
		version_uid: '2ef1e1ecc68195d503f349cfb937369a216c6ba1',
		...
		feature_ms_eventlog_changes: true,
...
<script type="text/javascript" src="https://a.slack-edge.com/9982f/js/rollup-core_web.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
		...
		<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/6be0c/js/rollup-secondary_a_required.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/8df80/js/codemirror_load.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
		...
		<script type="text/javascript">
				TS.clog.setTeam('T2H2J5V98');
				TS.clog.setUser('U2H2MLNMC');
			</script>
	...
	<!--
		...
		boot_data.file = {"id":"F362KCEQY","created":1479997127,"timestamp":1479997127,"name":"project_posting_trn.sql","title":"project_posting_trn.sql","mimetype":"text\/plain","filetype":"sql","pretty_type":"SQL","user":"U2HA8BCF8","editable":true,"size":2175,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T2H2J5V98-F362KCEQY\/project_posting_trn.sql","url_private_download":"https:\/\/files.slack.com\/files-pri\/T2H2J5V98-F362KCEQY\/download\/project_posting_trn.sql","permalink":"https:\/\/ramstalk.slack.com\/files\/ysr922\/F362KCEQY\/project_posting_trn.sql","permalink_public":"https:\/\/slack-files.com\/T2H2J5V98-F362KCEQY-cb0f9afc86","edit_link":"https:\/\/ramstalk.slack.com\/files\/ysr922\/F362KCEQY\/project_posting_trn.sql\/edit","preview":"-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)\r\n--\r\n-- Host: 127.0.0.1    Database: project\r\n-- ------------------------------------------------------\r\n-- Server version\t5.7.16-log\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E--\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E-- Host: 127.0.0.1    Database: project\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E-- ------------------------------------------------------\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E-- Server version\t5.7.16-log\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":57,"lines_more":52,"preview_is_truncated":true,"channels":["C2H9RGQ04"],"groups":[],"ims":[],"comments_count":0};
...
<!-- slack-www-hhvm145 / 2016-11-28 13:29:20 / v2ef1e1ecc68195d503f349cfb937369a216c6ba1 / B:H -->

...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/ysr922/F347BF81E/project_user_mst.sql?nojsmode=1" /></noscript>
<script>(function() {
        'use strict';
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>project_user_mst.sql | RAMs Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/85086199314?crumb=s-1480368587-78595b744e-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<p class="print_only">
	<strong>Created by ysr922 on November 20, 2016 at 8:01 PM</strong><br />
	<span class="subtle_silver break_word">https://ramstalk.slack.com/files/ysr922/F347BF81E/project_user_mst.sql</span>
</p>
...
<div class="alert_container">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T2H2J5V98-F347BF81E-7d16cd39c5" target="new">https://slack-files.com/T2H2J5V98-F347BF81E-7d16cd39c5</a>
</div></div>

<div id="file_page" class="card top_padding">

	<p class="small subtle_silver no_print meta">
		2KB SQL snippet created on <span class="date">November 20th 2016</span>.
...
-- Dump completed on 2016-11-20 20:00:16
</pre>
	...
	<div class="col span_4_of_6 no_right_padding">
		...
		<form action="https://ramstalk.slack.com/files/ysr922/F347BF81E/project_user_mst.sql"
	...
	<input type="hidden" name="crumb" value="s-1480368587-fbe229157c-☃" />
...
<script type="text/javascript" src="https://a.slack-edge.com/8df80/js/codemirror_load.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F347BF81E","created":1479639660,"timestamp":1479639660,"name":"project_user_mst.sql","title":"project_user_mst.sql","mimetype":"text\/plain","filetype":"sql","pretty_type":"SQL","user":"U2HA8BCF8","editable":true,"size":1970,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T2H2J5V98-F347BF81E\/project_user_mst.sql","url_private_download":"https:\/\/files.slack.com\/files-pri\/T2H2J5V98-F347BF81E\/download\/project_user_mst.sql","permalink":"https:\/\/ramstalk.slack.com\/files\/ysr922\/F347BF81E\/project_user_mst.sql","permalink_public":"https:\/\/slack-files.com\/T2H2J5V98-F347BF81E-7d16cd39c5","edit_link":"https:\/\/ramstalk.slack.com\/files\/ysr922\/F347BF81E\/project_user_mst.sql\/edit","preview":"-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)\r\n--\r\n-- Host: 127.0.0.1    Database: project\r\n-- ------------------------------------------------------\r\n-- Server version\t5.7.16-log\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E--\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E-- Host: 127.0.0.1    Database: project\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E-- ------------------------------------------------------\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E-- Server version\t5.7.16-log\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":53,"lines_more":48,"preview_is_truncated":true,"channels":["C2H9RGQ04"],"groups":[],"ims":[],"comments_count":0};
...
<!-- slack-www-hhvm10 / 2016-11-28 13:29:47 / v2ef1e1ecc68195d503f349cfb937369a216c6ba1 / B:H -->
